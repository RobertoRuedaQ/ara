...
class PromosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post promos_url, params: { promo: { category_id: @promo.category_id, description: @promo.description, imagen: @promo.imagen, title: @promo.title } }
    end
  ...
  test "should update promo" do
    patch promo_url(@promo), params: { promo: { category_id: @promo.category_id, description: @promo.description, imagen: @promo.imagen, title: @promo.title } }
